...
# Probably should be using ansible vault...
...
do
    ansible-playbook ./ansible/$PLAYBOOK -i $INVENTORY_PATH --user $USER_NAME --extra-vars "root_dir=$ROOT_DIRECTORY ansible_password=$ANSIBLE_PASSWORD ansible_become_password=$BECOME_PASSWORD" 
done